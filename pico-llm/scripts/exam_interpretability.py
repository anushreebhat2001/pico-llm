...
OUT_DIR = os.path.join(BASE_DIR, "outputs_postnorm_tinystories")

WEIGHTS_PATH = "/Users/utx/Desktop/pico-llm/pico-llm/outputs_postnorm_tinystories/kvcache_transformer_final_weights.pt"
...
model.load_state_dict(state, strict=False)  # should now load cleanly
model.eval()
...
if __name__ == "__main__":
    ...
    plot_attention_head(block_idx=3, head_idx=1)
